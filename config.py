...
TG_BOT_TOKEN = os.environ.get("TG_BOT_TOKEN", "8040135776:AAG3dMT7RrqZFIO5S3XKeHUZuMm8mfVvUI0") 
...
CHANNEL_ID = int(os.environ.get("CHANNEL_ID", "-1002030715343"))
...
DB_URL = os.environ.get("DB_URL", "mongodb+srv://Rajesh:Rajeah@rajesh.4m2jrxj.mongodb.net/?retryWrites=true&w=majority&appName=Rajesh")
# Enter the name of your MongoDB database.
DB_NAME = os.environ.get("DB_NAME", "Rajesh")
